...
`e`  |  Custom reaction. |  `e`
`@BotName insult`, `<@!211545201808769024> insult`  |  Custom reaction. |  `%mention% insult`
`@BotName praise`, `<@!211545201808769024> praise`  |  Custom reaction. |  `%mention% praise`
`@BotName pat`, `<@!211545201808769024> pat`  |  Custom reaction. |  `%mention% pat`
`@BotName cry`, `<@!211545201808769024> cry`  |  Custom reaction. |  `%mention% cry`
`@BotName are you real?`, `<@!211545201808769024> are you real?`  |  Custom reaction. |  `%mention% are you real?`
`@BotName are you there?`, `<@!211545201808769024> are you there?`  |  Custom reaction. |  `%mention% are you there?`
`@BotName draw`, `<@!211545201808769024> draw`  |  Custom reaction. |  `%mention% draw`
`@BotName bb`, `<@!211545201808769024> bb`  |  Custom reaction. |  `%mention% bb`
`@BotName call`, `<@!211545201808769024> call`  |  Custom reaction. |  `%mention% call`
`@BotName disguise`, `<@!211545201808769024> disguise`  |  Custom reaction. |  `%mention% disguise`
`@BotName inv`, `<@!211545201808769024> inv`  |  Custom reaction. |  `%mention% inv`
`@BotName threaten`, `<@!211545201808769024> threaten`  |  Custom reaction. |  `%mention% threaten`
`@BotName archer`, `<@!211545201808769024> archer`  |  Custom reaction. |  `%mention% archer`
`Sonic and Elise`  |  Custom reaction. |  `Sonic and Elise`
`*Sonic and Elise*`  |  Custom reaction. |  `*Sonic and Elise*`
`**Sonic and Elise**`  |  Custom reaction. |  `**Sonic and Elise**`
`***Sonic and Elise***`  |  Custom reaction. |  `***Sonic and Elise***`
`*Sonic x Elise*`  |  Custom reaction. |  `*Sonic x Elise*`
`**Sonic x Elise**`  |  Custom reaction. |  `**Sonic x Elise**`
`***Sonic x Elise***`  |  Custom reaction. |  `***Sonic x Elise***`
`Tomato`  |  Custom reaction. |  `Tomato`
`Potato`  |  Custom reaction. |  `Potato`
