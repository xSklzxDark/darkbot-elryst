    ...
    public class NadekoStats
    {
        ...
        public Task LoadStats() =>
            Task.Run(() =>
            {
                ...
                sb.AppendLine("`Author: xSklzx Dark` `Library: Discord.Net`");
                sb.AppendLine($"`Bot Version: 2.1 (Downgraded)`");
                sb.AppendLine($"`Bot id: {NadekoBot.Client.CurrentUser.Id}`");
                sb.AppendLine($"`Testers: KnucklesTheEchidna2399#8349, Dante the Gamer#3540, TheJojoNetwork#1694, SonicSwag123#1815`");
